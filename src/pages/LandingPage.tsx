...
const sectors = [
  ...
  { id: 'hospitality', name: 'Hospitality', icon: Home, color: 'from-pink-500 to-pink-600', description: 'Hotels, lodges, tourism' },
  { id: 'restaurant', name: 'Restaurant & Cafe', icon: Utensils, color: 'from-fuchsia-500 to-fuchsia-600', description: 'Restaurants, cafes, bars' },
