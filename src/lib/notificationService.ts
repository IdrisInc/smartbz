...
// Pre-defined notification templates with role targeting
export const NotificationTemplates = {
  ...
  organizationSuspended: (orgName: string, reason?: string) => ({
    ...
    targetRoles: ['super_admin', 'business_owner'],
  }),
  ...
  staffAdded: (name: string, role: string) => ({
    ...
    targetRoles: ['business_owner', 'manager', 'admin_staff'],
  }),
  ...
  saleCompleted: (saleNumber: string, amount: number) => ({
    ...
    targetRoles: ['business_owner', 'manager', 'sales_staff', 'cashier'],
  }),
  ...
  salePendingApproval: (saleNumber: string) => ({
    ...
    targetRoles: ['business_owner', 'manager'],
  }),
};
